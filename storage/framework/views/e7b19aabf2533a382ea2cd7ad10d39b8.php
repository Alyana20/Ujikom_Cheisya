            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($users->total()); ?></p>
                    </div>
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($users->where('role', 'admin')->count()); ?></p>
                    </div>
                ...
                <div class="mt-4 text-sm text-gray-500">
                    <span><?php echo e(number_format(($users->where('role', 'admin')->count() / $users->total()) * 100, 1)); ?>% dari
                        total</span>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($users->where('role', 'vendor')->count()); ?></p>
                    </div>
                ...
                <div class="mt-4 text-sm text-gray-500">
                    <span><?php echo e(number_format(($users->where('role', 'vendor')->count() / $users->total()) * 100, 1)); ?>% dari
                        total</span>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800"><?php echo e($users->where('role', 'customer')->count()); ?></p>
                    </div>
                ...
                <div class="mt-4 text-sm text-gray-500">
                    <span><?php echo e(number_format(($users->where('role', 'customer')->count() / $users->total()) * 100, 1)); ?>% dari
                        total</span>
                </div>
            </div>
        </div>
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <div class="flex justify-between items-center">
                ...
                <div class="text-sm text-gray-600">
                    Menampilkan <?php echo e($users->count()); ?> dari <?php echo e($users->total()); ?> pengguna
                </div>
            </div>
        </div>
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    ...
                                    <i
                                        class="fas <?php echo e($user->role === 'admin' ? 'fa-crown' : ($user->role === 'vendor' ? 'fa-store' : 'fa-user')); ?> mr-1"></i>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                <?php if($user->store && $user->store->status === 'approved'): ?>
                                    <div class="flex items-center">
                                        <i class="fas fa-store text-green-500 mr-2"></i>
                                        <div>
                                            <span class="text-gray-900 font-medium"><?php echo e($user->store->name); ?></span>
                                ...
                                <?php elseif($user->store && $user->store->status === 'pending'): ?>
                                    <div class="flex items-center">
                                    ...
                                    <?php if($user->id !== auth()->id()): ?>
                                        <form action="<?php echo e(route('admin.users.destroy', $user)); ?>" method="POST"
                                            ...
                                            <button type="submit"
                                                ...
                                                onclick="return confirm('Yakin hapus user <?php echo e($user->name); ?>?')">
                                                <i
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PERKULIAHAN\LSP\Ujikom_Cheisya\resources\views/admin/users/index.blade.php ENDPATH**/ ?>