        ...
        <div
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-gray-500">
                    ...
                    <?php echo e($stats['total_customers'] ?? 0); ?> Customer, <?php echo e($stats['total_vendors'] ?? 0); ?> Vendor
                </span>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_stores'] ?? 0); ?></p>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-green-500 flex items-center">
                    ...
                    <?php echo e($stats['approved_stores'] ?? 0); ?> Disetujui
                </span>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['total_products'] ?? 0); ?></p>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-gray-500">
                    ...
                    dari <?php echo e($stats['total_stores'] ?? 0); ?> toko
                </span>
            </div>
        </div>
        ...
        <div
            ...
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800"><?php echo e($stats['pending_stores'] ?? 0); ?></p>
                </div>
            ...
            <div class="mt-4">
                <a href="<?php echo e(route('admin.shop-requests.index')); ?>" class="text-purple-600 text-sm font-medium hover:text-purple-700 flex items-center">
                    Lihat detail
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PERKULIAHAN\LSP\Ujikom_Cheisya\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>