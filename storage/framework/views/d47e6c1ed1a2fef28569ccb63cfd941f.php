                        ...
                        <div
                            ...
                            <div class="p-6">
                                ...
                                <span
                                    ...
                                    <?php echo e($product->category->name ?? 'Produk'); ?>

                                </span>

                                <!-- Product Name -->
                                <a href="<?php echo e(route('products.show', $product)); ?>" class="hover:text-blue-600 block mb-2">
                                    <h3 class="font-semibold text-lg line-clamp-2"><?php echo e($product->name); ?></h3>
                                </a>
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <?php if($shopRequest): ?>
                            ...
                            <div class="text-center py-4">
                                <?php if($shopRequest->status === 'pending'): ?>
                                ...
                                <?php elseif($shopRequest->status === 'approved'): ?>
                                ...
                                <?php elseif($shopRequest->status === 'rejected'): ?>
                                    <div class="bg-red-50 border border-red-200 rounded-lg p-4 mb-4">
                                        ...
                                        <p class="text-sm text-red-700 mb-2">
                                            <?php echo e($shopRequest->rejection_reason ?? 'Pengajuan Anda ditolak.'); ?>

                                        </p>
                                        <a href="<?php echo e(route('shop-request.edit')); ?>" 
                                ...
                                <a href="<?php echo e(route('shop-request.show')); ?>" 
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('shop-request.create')); ?>" 
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="space-y-3">
                                ...
                                <div class="text-sm text-gray-500">
                                    Belum punya akun?
                                    <a href="<?php echo e(route('vendor.register')); ?>" class="text-purple-600 hover:text-purple-800 font-semibold">
                                        Daftar di sini
                                    </a>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.marketplace', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PERKULIAHAN\LSP\Ujikom_Cheisya\resources\views/visitor/home.blade.php ENDPATH**/ ?>