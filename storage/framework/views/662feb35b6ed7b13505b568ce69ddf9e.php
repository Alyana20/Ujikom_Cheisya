...
<?php $__env->startSection('content'); ?>
    ...
    <div class="bg-gray-50 rounded-lg p-6 mb-6">
        <form method="GET" action="<?php echo e(route('admin.stores.index')); ?>" class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-2">Cari Toko</label>
                <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nama toko, pemilik, email..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
            </div>
            <div>
            ...
            <div class="flex items-end gap-2">
                ...
                <a href="<?php echo e(route('admin.stores.index')); ?>" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg">
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-yellow-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($stores->where('status', 'pending')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($stores->where('status', 'approved')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-gray-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($stores->where('status', 'inactive')->count()); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-red-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold"><?php echo e($stores->where('status', 'rejected')->count()); ?></p>
                </div>
                    ...
                    <tr>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm font-medium text-gray-900"><?php echo e($store->name); ?></div>
                                    <div class="text-sm text-gray-500"><?php echo e(Str::limit($store->description, 50)); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900"><?php echo e($store->user->name); ?></div>
                            <div class="text-sm text-gray-500"><?php echo e($store->user->email); ?></div>
                        </td>
                        <td class="px-6 py-4">
                            <div class="text-sm text-gray-900"><i class="fas fa-phone text-gray-400 mr-1"></i><?php echo e($store->phone); ?></div>
                            <div class="text-sm text-gray-500 mt-1"><i class="fas fa-map-marker-alt text-gray-400 mr-1"></i><?php echo e(Str::limit($store->address, 30)); ?></div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500"><?php echo e($store->created_at->format('d M Y')); ?></td>
                        <td class="px-6 py-4 text-center">
                            <?php if($store->status === 'pending'): ?>
                                <form action="<?php echo e(route('admin.stores.approve', $store->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('admin.stores.reject', $store->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                            ...
                            <?php elseif($store->status === 'approved'): ?>
                                <form action="<?php echo e(route('admin.stores.toggle-active', $store->id)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PERKULIAHAN\LSP\Ujikom_Cheisya\resources\views/admin/stores/index.blade.php ENDPATH**/ ?>