...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?> - OSS Healthcare Admin</title>
        ...
        <div class="flex flex-1 relative">
            ...
            <main class="flex-1 p-6 md:p-8 bg-gray-50 min-h-screen">
                <div class="max-w-7xl mx-auto">
                            ...
                            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                                ...
                                <li aria-current="page">
                                    <div class="flex items-center">
                                        ...
                                        <span
                                            class="ml-1 text-sm font-medium text-gray-500 md:ml-2"><?php echo $__env->yieldContent('title'); ?></span>
                                    </div>
                                </li>
                            </ol>
                        </nav>
                    ...
                    <!-- Page Header -->
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold text-gray-800"><?php echo $__env->yieldContent('title'); ?></h1>
...
<?php /**PATH D:\PERKULIAHAN\LSP\Ujikom_Cheisya\resources\views/layouts/admin.blade.php ENDPATH**/ ?>