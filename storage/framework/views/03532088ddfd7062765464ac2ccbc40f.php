...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Vendor Dashboard'); ?> - Toko Alat Kesehatan</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center">
                    <a href="<?php echo e(route('vendor.dashboard')); ?>" class="flex items-center space-x-3">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                             ...
                             style="display: none;">
                            <a href="<?php echo e(route('vendor.profile.index')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-700">
                                <i class="fas fa-user-circle mr-2"></i>
                                Profil Saya
                            </a>
                            <a href="<?php echo e(route('vendor.dashboard')); ?>" class="block px-4 py-2 text-gray-700 hover:bg-green-50 hover:text-green-700">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
            <nav class="flex text-sm text-gray-600">
                <?php $__currentLoopData = $breadcrumbs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!$loop->last): ?>
                        <a href="<?php echo e($url); ?>" class="hover:text-green-600"><?php echo e($label); ?></a>
                        <span class="mx-2">/</span>
                    <?php else: ?>
                        <span class="text-gray-900 font-semibold"><?php echo e($label); ?></span>
                    <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="text-gray-600 text-sm mb-4 md:mb-0">
                    ...
                    <?php echo e(date('Y')); ?> Toko Alat Kesehatan. All rights reserved.
                </div>
                <div class="flex space-x-6 text-sm text-gray-600">
                    <a href="<?php echo e(route('home')); ?>" class="hover:text-green-600">
...
<?php /**PATH D:\PERKULIAHAN\LSP\Ujikom_Cheisya\resources\views/layouts/vendor.blade.php ENDPATH**/ ?>