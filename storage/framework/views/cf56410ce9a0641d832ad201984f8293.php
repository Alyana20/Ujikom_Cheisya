<?php $__env->startSection('content'); ?>
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <!-- Back Link -->
        <div class="mb-6">
            <a href="<?php echo e(route('products.index')); ?>" class="text-blue-600 hover:text-blue-700 font-semibold flex items-center">
...
<?php echo $__env->make('layouts.marketplace', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\PERKULIAHAN\LSP\Ujikom_Cheisya\resources\views/visitor/products/category.blade.php ENDPATH**/ ?>